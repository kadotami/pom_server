...
stdout_path "/var/log/pom_server/unicorn.stdout_#{application}.log"  # 標準出力ログ出力先
stderr_path "/var/log/pom_server/unicorn.stderr_#{application}.log"  # 標準エラー出力ログ出力先
